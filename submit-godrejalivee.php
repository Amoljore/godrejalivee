	...
	{		
		...
		$usermessage = "Good day,<br><br>
				Thank you for your time and interest in <strong>Godrej Alive</strong> Project<br><br>
					...
					To get in touch directly, you may call us on 9820851321 <br><br>
					Regards,<br>
                    ...
                    <strong>Mobile: +919820851321</strong>";
...
if(isset($_POST["floor_plan"]))
{
	 //echo "<pre>";print_r($_POST);die();
	$fullname = $_POST['name'];
	$email_id = $_POST['email'];
	$mobile = $_POST['mobile'];
	$flat_type = $_POST['floor_plan_val'];
    $utm_source = $_POST['utm_source'];
	$utm_medium = $_POST['utm_medium'];
	$utm_campaign = $_POST['utm_campaign'];
	$fp_path = $_POST['fp_path'];
	$email_body = "Name: $fullname<br><br>
	Email Id: $email_id<br><br>
	Mobile: $mobile<br><br>
	Flat Type: $flat_type<br><br>";
	
	if($fullname == '' || $email_id == '' || $mobile == '')
	{
		header("Location: $home_url?error_floor_plan=1");
	}
else
{
    $to = array("info@riogapremium.com",$email_id);
	
    $subject = "Enquiry for Floor Plan from Godrej Alive - India ";
    ...
    $floor_plan = '/docs/Floor_Plan_1.pdf';
    	$floor_plan = $fp_path;
    echo '
	<a style = "display:none" id="link" href="'.$floor_plan.'" download = "'.$floor_plan.'" >Download</a>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
	<script type="text/javascript">
		 	DoTheRedirect("' . $thank_you_url . '");
...
if(isset($_POST["register"]))
{
    ...
    $subject = "Enquiry for Register from Godrej Alive - India ";
...
function send_mail($to,$content,$subject,$user_subject = "",$user_content = "")
{
    ...
    $mail->addBCC("yogeshr@riogapremium.com");
...
{
    $con = mysqli_connect("localhost","godrejal_alivee1","$[3]obe%_!fH","godrejal_godrejalivee");
